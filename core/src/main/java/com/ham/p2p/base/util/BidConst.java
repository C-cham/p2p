...
public class BidConst {
    ...
    public static final int MESSAGE_VALID_TIME = 5;//验证码有效时长5分钟
    public static final int EMAIL_VALID_TIME = 5;//邮箱验证时长5天
    public static final int CREDIT_BORROW_SCORE = 30;//风控评分
    public static final int MESSAGE_INTERVAL_TIME = 60;//发送时间间隔
